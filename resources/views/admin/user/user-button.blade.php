<div>
     ...
     <button type="button" data-table="products" data-form-modal="addEditUserModal"
    ...
    <button type="button" data-table="products" data-uuid="{{ $data->uuid }}" data-action="{{route('admin.user.status',[$data->id])}}"
